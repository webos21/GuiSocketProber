...
import com.gmail.webos21.gsp.MyTrustManager;
import com.gmail.webos21.gsp.SocketClient;
...
public class SocketTestClient extends JPanel {
	...
	/*
	 * public static void main(String args[]) { SocketTestClient client=new
	 * SocketTestClient(); client.setTitle("SocketTest Client"); //client.pack();
	 * client.setSize(500,400); Util.centerWindow(client);
	 * client.setDefaultCloseOperation(EXIT_ON_CLOSE);
	 * client.setIconImage(client.logo.getImage()); client.setVisible(true); }
	 */
	...
	private void connect() {
		...
		if (ip == null || ip.equals("")) {
			JOptionPane.showMessageDialog(SocketTestClient.this, "No IP Address. Please enter IP Address",
		...
		if (port == null || port.equals("")) {
			JOptionPane.showMessageDialog(SocketTestClient.this, "No Port number. Please enter Port number",
					"Error connecting", JOptionPane.ERROR_MESSAGE);
			portField.requestFocus();
			portField.selectAll();
			return;
		...
		if (!Util.checkHost(ip)) {
			JOptionPane.showMessageDialog(SocketTestClient.this, "Bad IP Address", "Error connecting",
		...
		try {
			...
			JOptionPane.showMessageDialog(SocketTestClient.this, "Bad Port number. Please enter Port number",
					"Error connecting", JOptionPane.ERROR_MESSAGE);
			portField.requestFocus();
			portField.selectAll();
			setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
