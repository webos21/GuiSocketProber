...
import com.gmail.webos21.gsp.UdpServer;
...
public class SocketTestUdp extends JPanel /* JFrame */ {
	...
	private JLabel logoLabel = new JLabel("SocketProber v1.0", logo, JLabel.CENTER);
	...
	public SocketTestUdp(final JFrame parent) {
		...
		convPanel.add(jsp);
		convPanel.setBorder(new CompoundBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10), convBorder));
		...
		ActionListener sendListener = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!msg.equals(""))
					...
					int value = JOptionPane.showConfirmDialog(SocketTestUdp.this, "Send Blank Line ?",
		...
		clientPanel.setBorder(new CompoundBorder(BorderFactory.createEmptyBorder(0, 0, 0, 3),
	...
	private void listen() {
		...
		if (ip == null || ip.equals("")) {
			JOptionPane.showMessageDialog(SocketTestUdp.this, "No IP Address. Please enter IP Address",
		...
		if (port == null || port.equals("")) {
			JOptionPane.showMessageDialog(SocketTestUdp.this, "No Port number. Please enter Port number",
					"Error connecting", JOptionPane.ERROR_MESSAGE);
			portField1.requestFocus();
		...
		if (!Util.checkHost(ip)) {
			JOptionPane.showMessageDialog(SocketTestUdp.this, "Bad IP Address", "Error connecting",
		...
		try {
			...
			JOptionPane.showMessageDialog(SocketTestUdp.this, "Bad Port number. Please enter Port number",
					"Error connecting", JOptionPane.ERROR_MESSAGE);
			portField1.requestFocus();
			portField1.selectAll();
			setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	...
	public void sendMessage(String s) {
		try {
			...
			JOptionPane.showMessageDialog(SocketTestUdp.this, e.getMessage(), "Error Sending Message",
					JOptionPane.ERROR_MESSAGE);
			client = null;
		}
	}
	...
	public void error(String error) {
		if (error == null || error.equals(""))
			return;
		JOptionPane.showMessageDialog(SocketTestUdp.this, error, "Error", JOptionPane.ERROR_MESSAGE);
	}

	public void error(String error, String heading) {
		if (error == null || error.equals(""))
			return;
		JOptionPane.showMessageDialog(SocketTestUdp.this, error, heading, JOptionPane.ERROR_MESSAGE);
	}
