...
public class UdpServer extends Thread {
	...
	public static synchronized UdpServer handle(SocketTestUdp parent, DatagramSocket s) {
		if (udpServer == null)
	...
	public static synchronized UdpServer handleClient(SocketTestUdp parent, DatagramSocket s) {
		if (udpServer2 == null)
